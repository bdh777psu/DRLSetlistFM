//
// SFMuseruserIdattendedAPI.swift
//
...
open class SFMuseruserIdattendedAPI {
    /**
     .
     ...
     */
    open class func resourceUserUserIdAttendedGetUserAttendedSetlistsGET(userId: String, p: Int? = nil, completion: @escaping ((_ data: JsonSetlists?,_ error: Error?) -> Void)) {
        resourceUserUserIdAttendedGetUserAttendedSetlistsGETWithRequestBuilder(userId: userId, p: p).execute { (response, error) -> Void in
  ...
  "itemsPerPage" : 20
     ...
     */
    open class func resourceUserUserIdAttendedGetUserAttendedSetlistsGETWithRequestBuilder(userId: String, p: Int? = nil) -> RequestBuilder<JsonSetlists> {
