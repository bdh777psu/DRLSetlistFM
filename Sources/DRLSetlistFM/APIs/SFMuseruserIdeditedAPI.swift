...
open class SFMuseruserIdeditedAPI {
    /**
     .
     ...
     */
    open class func resourceUserUserIdEditedGetUserEditedSetlistsGET(userId: String, p: Int? = nil, completion: @escaping ((_ data: JsonSetlists?,_ error: Error?) -> Void)) {
        resourceUserUserIdEditedGetUserEditedSetlistsGETWithRequestBuilder(userId: userId, p: p).execute { (response, error) -> Void in
  ...
  "itemsPerPage" : 20
     ...
     */
    open class func resourceUserUserIdEditedGetUserEditedSetlistsGETWithRequestBuilder(userId: String, p: Int? = nil) -> RequestBuilder<JsonSetlists> {
