...
open class SFMartistmbidsetlistsAPI {
     ...
     */
    open class func resourceArtistMbidSetlistsGetArtistSetlistsGET(mbid: String, p: Int? = nil, completion: @escaping ((_ data: JsonSetlists?,_ error: Error?) -> Void)) {
        resourceArtistMbidSetlistsGetArtistSetlistsGETWithRequestBuilder(mbid: mbid, p: p).execute { (response, error) -> Void in
  ...
  "itemsPerPage" : 20
     ...
     */
    open class func resourceArtistMbidSetlistsGetArtistSetlistsGETWithRequestBuilder(mbid: String, p: Int? = nil) -> RequestBuilder<JsonSetlists> {
